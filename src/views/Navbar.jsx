...
function Navbar({ favoritesLength, setTheme }) {
	return (
		<div className="  w-full bg-primary p-2 fixed top-0 left-0 right-0 z-50 flex items-center justify-between gap-8 flex-col-reverse md:flex-row">
			<SearchBar
