...
function Navigation({ favoritesLength, setTheme }) {
	return (
		<ul className=" flex items-center justify-end flex-nowrap">
			<li className="mx-4 md:m0 md:mb-2 relative ">
				<Link to={`/`}>
					<img
						className="h-20 p-2 block  "
						src={Logo}
						alt=""
					/>
				</Link>
			...
			<li className="mx-4 md:m0 md:mb-2  relative ">
				<Link to={`/favorite`}>
					...
					<svg
						className="h-16 p-2 text-gray-500 hover:text-pink-600 svg-inline--fa fa-heart fa-w-16 fa-9x"
						aria-hidden="true"
						focusable="false"
						data-prefix="far"
						data-icon="heart"
			...
			<li className="mx-4 md:m0 md:mb-2 ">
				<a
					className=""
					href=""
				>
					<svg
						className="h-16    p-2 text-gray-500 hover:text-blue-400 svg-inline--fa fa-heart fa-w-16 fa-9x"
						aria-hidden="true"
						focusable="false"
						data-prefix="far"
						data-icon="random"
			...
			<li className=" mx-4 md:m0 md:mb-2 w-16 p-2 relative ">
